...
namespace sepetteYemek.Controllers
{
    ...
    public class istatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d9 = deger9;
            var deger10 = c .Uruns.Count(x => x.UrunAd == "Su").ToString();
            ViewBag.d10 = deger10;
            var deger11 = c.Uruns.Count(x => x.UrunAd == "Bebek Bezi").ToString();
            ViewBag.d11 = deger11;
            ...
            var deger15 = c.SatisHarekets.Where(x => x.Tarih == bugun).Sum(y => (decimal?)y.Adet).ToString();
            ViewBag.d15 = deger15;
            var deger16 = c.SatisHarekets.Where(x => x.Tarih == bugun).Sum(y => (decimal?)y.Fiyat * y.Adet).ToString();
            ViewBag.d16 = deger16;
